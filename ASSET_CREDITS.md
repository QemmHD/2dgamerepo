...
| `src/assets/obstacles/floor_cabin_clean.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original material-only oak board field for the House V3 continuous foundation, rendered at 512×410 by `tools/blender/render_house_v2_props.py`, then installed through the repository pixel-art pipeline at a 128px logical cell and 32-color palette. It contains no baked room, wall, rug, furniture, external mesh, or external texture. |
| `src/assets/obstacles/cabin_bed.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead sleeping-nook furnishing, rendered by `tools/blender/render_house_v2_props.py` and installed as a transparent 256×256 pixel-plan PNG by `tools/artshot/pixelate-sheet.mjs` (64px logical cell, 24 colors, hard alpha, one-cell outline). No external mesh or texture. |
| `src/assets/obstacles/cabin_hearth.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead low stone-hearth furnishing, rendered and installed through the same 64px/24-color pixel-plan pipeline. No external mesh or texture. |
| `src/assets/obstacles/cabin_table.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead dining/work table furnishing, rendered and installed through the same 64px/24-color pixel-plan pipeline. No external mesh or texture. |
| `src/assets/obstacles/cabin_shelf.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead pantry-counter furnishing, rendered and installed through the same 64px/24-color pixel-plan pipeline. No external mesh or texture. |
| `src/assets/obstacles/cabin_crate.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead House V3 supply crate, rendered and installed through the same 64px/24-color pixel-plan pipeline. No external mesh or texture. |
| `src/assets/obstacles/cabin_barrel.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead House V3 wick-oil cask, rendered and installed through the same 64px/24-color pixel-plan pipeline. No external mesh or texture. |
| `src/assets/obstacles/ruin_bell.png` | Generated | Blender 5.1 (deterministic `bpy` + Eevee) | Original exact-overhead Ruin Bell encounter prop, rendered by `tools/blender/render_house_v2_props.py` and installed as a transparent 256×256 pixel-plan PNG by `tools/artshot/pixelate-sheet.mjs` (64px logical cell, 24 colors, hard alpha, one-cell outline). No external mesh or texture. |
