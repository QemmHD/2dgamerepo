...
export const WEAPONS = {
    arcaneBolt: {
        ...
        perLevel: [
            ...
            { damage: 20, cooldown: 0.52, projectileSpeed: 940,  pierce: 0, projectileRadius: 15, ricochet: 0, ricochetRange: 360 },
    ...
    holyPulse: {
        ...
        perLevel: [
            null,
            { radius: 220, damage: 12, cooldown: 3.0, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 2 },
            { radius: 240, damage: 14, cooldown: 2.8, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 2 },
            { radius: 260, damage: 17, cooldown: 2.6, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 3 },
            { radius: 280, damage: 19, cooldown: 2.4, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 3 },
            { radius: 310, damage: 22, cooldown: 2.2, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 3 },
            { radius: 340, damage: 26, cooldown: 2.0, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 4 },
            { radius: 380, damage: 31, cooldown: 1.8, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 4 },
            { radius: 420, damage: 38, cooldown: 1.6, shredPerStack: 0.10, shredDuration: 4.0, maxShredStacks: 4 },
        ],
