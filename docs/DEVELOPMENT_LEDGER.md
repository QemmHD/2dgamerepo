...
| V1-ART | Heroes/bosses/houses | `[~] IN FLIGHT` | PR #192 shipped the six-hero deterministic Blender/animated-attachment foundation; gameplay silhouettes/collision measured | Preserve the 18-sheet install manifest, exact head/shoulder/hand pose contract, and six-hero browser matrix; expand the cosmetic inventory, then produce the 12 boss identity sets and first modular house kit. | PR #192; main `e8ec79f`; cosmetic gate **4,387** |
