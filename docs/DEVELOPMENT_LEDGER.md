...
**Main baseline:** [`b43baae`](https://github.com/QemmHD/2dgamerepo/commit/b43baae408e423bb79758db6a3beda965a02841c) — merged [PR #202](https://github.com/QemmHD/2dgamerepo/pull/202), the deployed PR #201 evidence reconciliation
**Active branch at grounding:** `feature/collection-completion-truth` at `35be073`, draft [PR #203](https://github.com/QemmHD/2dgamerepo/pull/203); its bounded Collection Completion Truth and protected-transaction candidate is accepted but not shipped
**Latest shipped feature commit:** [`45f6216`](https://github.com/QemmHD/2dgamerepo/commit/45f62160cc2446d92e8c8bde220c491d5074fb77)
**Shipped ledger baseline before this tranche:** [`b43baae`](https://github.com/QemmHD/2dgamerepo/commit/b43baae408e423bb79758db6a3beda965a02841c); when this file is on `main`, its containing commit is the newer ledger truth
...
**Collection Completion Truth candidate — not shipped:** draft
[PR #203](https://github.com/QemmHD/2dgamerepo/pull/203) at feature head `35be073`
...
The candidate boundary is **201,775 checks**, **34/34 validators**, and syntax
...
`8331705612` and optimized final-head CI
[`29386954424`](https://github.com/QemmHD/2dgamerepo/actions/runs/29386954424)/artifact
`8331811265` passed. Merge, `main` CI, Pages, cache-busted public smoke, and deployed
`?dev=1` retention remain pending. This does not complete Collection Growth I, A11-13,
...
| V1-ECO | Cases/Mines/upgrades | `[~] IN FLIGHT` | LV-04 fair-risk foundation plus PR #198/#200 source-honest Boutique/Case partitions and atomic look checkout shipped; PR #203's accepted candidate resolves the two named Mythic tails and protects earned-coin/once-only transactions, but merge/deploy are pending | Preserve the **674**-check current gambling contract, **93%** theoretical Mines return, exact Case pools/order/costs/odds/pity/unowned weighting/duplicates, and all source exclusions. PR #203 adds exactly two 72,000 earned-coin Blueprint routes; never represent 80 random Royal entries as equivalent certainty. Land its protected Case/Mines/Battle Pass/Daily/shop flows, then complete the remaining Fair Forge/Forge Reserve simulation, accessibility, and presentation work. | LV-04; PR #198; PR #200; PR #203 candidate; final-head CI `29386954424` |
| V1-PROG | Chapters/cosmetics/save | `[~] IN FLIGHT` | LV-03 Waylight/progression, PR #196 atomic Run Path settlement, and PR #198/#200 Collection Growth I-A/I-B shipped: 103 items, 15 sets, six per-hero presets, persistent pursuit, and atomic look transactions. PR #203's accepted candidate adds completion/category/set/source receipts and additive save-v10 `blueprintClaims`; merge/deploy are pending. | Preserve Waylight, Run Path settlement, all-103 source truth, additive save-v10 migrations, and the selected-hero compatibility mirror. Land PR #203, then add the permanent chapter shelf and export/recovery; do not recreate I-B or promote full Collection Growth I/2.8. | LV-03; PR #196; PR #198; PR #200; PR #203 candidate; final-head CI `29386954424` |
...
- [x] Current accepted-candidate evidence is recorded without calling it deployed:
...
3. **Use the grounded delivery evidence.** PR #196/main `5abd6fd` owns the Run Path
   ...
   undiscovered relic attunement. PR #203 at `35be073` owns only an accepted candidate:
...
4. **Land and deploy PR #203; then begin House V2/Ruin Bell.** Preserve PR #192's
   pose/install/browser contract and PR #198/#200 paging, reachability, source,
   attachment, preset, atomicity, Reduced Effects, and no-power contracts. Do not call
   the candidate shipped until merge, `main` CI, Pages, cache-busted public smoke, and
   deployed `?dev=1` retention are recorded. Then build one original Emberwood cabin
   and one 45–60 second Ruin Bell encounter through shared render/collision/nav/LOS/
   door/spawn/room/roof truth. Keep A11-11's tutorial/debrief moving in parallel; the
