...
| V1-ART | Heroes/bosses/houses | `[~] IN FLIGHT` | Six-hero deterministic Blender/animated-attachment candidate is published in PR #192; gameplay silhouettes/collision measured | Preserve the 18-sheet install manifest, exact head/shoulder/hand pose contract, and six-hero browser matrix; expand the cosmetic inventory, then produce the 12 boss identity sets and first modular house kit. | PR #192; `c2d044d`; cosmetic gate **4,387** |
...
| 2026-07-14 | Six-hero cosmetic pose rig candidate / `agent/cosmetic-pose-rig` | Promoted V1-ART to `[~] IN FLIGHT`; replaced fixed cosmetic offsets with exact per-hero head/shoulder/hand transforms across gameplay and four menu surfaces; unified all 18 body sheets; made replaceable native headwear and every held prop pose-safe; added deterministic Blender, install-manifest, PNG-style, contact-sheet, and browser contracts. More cosmetics, boss identities, houses, and device acceptance remain open. | Head `c2d044d`; PR [#192](https://github.com/QemmHD/2dgamerepo/pull/192). Local syntax **162/162**, validators **22/22**, cosmetic contract **4,387**, and browser matrix `DONE EXC:0 heroes:6 variants:12 frames:324 replaceable:3`; fresh Character/Boutique/gameplay/`?dev=1` receipts have zero error logs. | Pass hosted PR CI, merge, deploy and live-smoke before calling this bounded slice shipped; then reconcile receipts and start the exact unique-per-map three-boss ledger. |
