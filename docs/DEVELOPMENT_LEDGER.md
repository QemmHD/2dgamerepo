...
**Active branch at grounding:** `agent/first-light-preferences` from `origin/main` at `d7801e5`; current A11-10 work remains branch-only until its feature commit/PR is recorded
