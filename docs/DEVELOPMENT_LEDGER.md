...
**Main baseline:** [`a34baca`](https://github.com/QemmHD/2dgamerepo/commit/a34bacafac2cd222e0a55c3e94545f6535a3acf2) — merged [PR #200](https://github.com/QemmHD/2dgamerepo/pull/200), the delivered Collection Growth I-B 30-piece/preset/pursuit slice
**Active branch at grounding:** `docs/collection-growth-ib-evidence` from `origin/main` at `a34baca`; this branch records the shipped I-B boundary without promoting complete Collection Growth I, A11-13, full 1.1/1.6, the 1.0 → 2.0 arc, 2.0, or 2.8
**Latest shipped feature commit:** [`a34baca`](https://github.com/QemmHD/2dgamerepo/commit/a34bacafac2cd222e0a55c3e94545f6535a3acf2)
**Shipped ledger baseline before this tranche:** [`82d7208`](https://github.com/QemmHD/2dgamerepo/commit/82d7208), the [PR #199](https://github.com/QemmHD/2dgamerepo/pull/199) Collection Growth I-A evidence reconciliation; when this file is on `main`, its containing commit is the newer ledger truth
...
The current feature boundary is **198,394 assertions**: Collection **9,981**;
...
contains four exact Collection/Boutique production-harness receipts. The detailed
...
- [x] Current integrated evidence is recorded: **198,394 assertions**; Run Path
      **93,139**; HUD **14,001/180**; Collection **9,981**; attachment **7,332**
      across 162 frames/810 points; progression **5,860**; accessibility **299**;
      UX **100**; gambling **644**; validators **25/25**; and syntax **169/169**.
...
3. **Use the grounded delivery evidence.** PR #196/main `5abd6fd` owns the Run Path
   ...
   reachability/source/paging contract. PR #200/main `a34baca` owns the current all-103
   ...
   freeze, and fail-closed source/grant/migration behavior. The current integrated
   boundary is **198,394 assertions**, **25/25** validators, and syntax **169/169**.
