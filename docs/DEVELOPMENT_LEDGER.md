...
**Current 1.1 commit / PR:** pending / pending
...
**1.1 in-flight boundary:** A11 source and validators exist only on the current
feature branch. Local evidence is recorded below, but PR, hosted
CI, merge, Pages deploy, and deployed smoke slots are all pending. Selected 1.0.2
...
- [ ] Assign the 1.1 commit, PR, hosted CI, merge, Pages deploy, and deployed smoke slots.
